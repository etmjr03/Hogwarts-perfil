...
<html lang="en">
  ...
  <body>
      <?php require_once __DIR__.'./nav-layout.php'; ?>

    <div class="layout">

      <img class="corvinal" src="./imagens/corvinal.png" alt="">
      <img class="lufa-lufa" src="./imagens/lufa-lufa.png" alt="">
      <img class="grifinoria" src="./imagens/grifinoria.png" alt="">
      <img class="sonserina" src="./imagens/sonserina.png" alt="">
